...
Для тестирования функциональности расширения:
1. Откройте файл `test-page.html` в браузере
2. Убедитесь что расширение установлено и активно
3. Нажмите на кнопки тестовых сценариев
4. Расширение должно перехватить вызовы и показать предупреждения

Тестовые сценарии включают:
- Высокие переводы (>= 1 ETH)
- Неограниченные разрешения (MAX_UINT256)
- SetApprovalForAll для NFT
- Чувствительные функции администратора
- Обычные переводы (должны проходить)
